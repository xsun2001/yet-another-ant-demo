...
export const DefaultConfig: GameConfig = {
  ...
  towers: [
    ...
    { type: 1,  name: "Heavy",   damage:10, range: 2, interval: 2, baseType: 0, cost:  60, attack: { type: "normal" } },
    { type: 11, name: "Heavy+",  damage:28, range: 2, interval: 2, baseType: 1, cost: 100, attack: { type: "normal" } },
    { type: 12, name: "Ice",     damage:15, range: 2, interval: 2, baseType: 1, cost: 100, attack: { type: "ice" } },
    { type: 13, name: "Cannon",  damage:50, range: 2, interval: 4, baseType: 1, cost: 100, attack: { type: "normal" } },
    { type: 2,  name: "Quick",   damage: 6, range: 3, interval: 1, baseType: 0, cost:  60, attack: { type: "normal" } },
    { type: 21, name: "Quick+",  damage: 8, range: 4, interval: 1, baseType: 2, cost: 100, attack: { type: "normal", attackCount: 2 } },
    { type: 22, name: "Double",  damage:10, range: 4, interval: 1, baseType: 2, cost: 100, attack: { type: "normal", targetCount: 2 } },
    { type: 23, name: "Sniper",  damage:15, range: 6, interval: 1, baseType: 2, cost: 100, attack: { type: "normal" } },
    { type: 3,  name: "Mortar",  damage:16, range: 4, interval: 4, baseType: 0, cost:  60, attack: { type: "aoe", aoeRange: 1 } },
    { type: 31, name: "Mortar+", damage:35, range: 4, interval: 4, baseType: 3, cost: 100, attack: { type: "aoe", aoeRange: 1 } },
    { type: 32, name: "Pulse",   damage:30, range: 2, interval: 3, baseType: 3, cost: 100, attack: { type: "pulse" } },
    { type: 33, name: "Missile", damage:45, range: 5, interval: 6, baseType: 3, cost: 100, attack: { type: "aoe", aoeRange: 2 } },
  ],
  newTowerCost: 15,
  superWeapon: [
    { cost: 150, cd: 100 },
