...
export const DefaultConfig: GameConfig = {
  ...
  towers: [
    ...
    { type: 1,  name: "Heavy",   damage:15, range: 2, interval: 2, baseType: 0, cost:  60, attack: { type: "normal" } },
    { type: 11, name: "Heavy+",  damage:35, range: 2, interval: 2, baseType: 1, cost: 200, attack: { type: "normal" } },
    { type: 12, name: "Ice",     damage:15, range: 2, interval: 2, baseType: 1, cost: 200, attack: { type: "ice" } },
    { type: 13, name: "Cannon",  damage:50, range: 2, interval: 4, baseType: 1, cost: 200, attack: { type: "normal" } },
    ...
    { type: 22, name: "Double",  damage:10, range: 4, interval: 1, baseType: 2, cost: 200, attack: { type: "normal", targetCount: 2 } },
    { type: 23, name: "Sniper",  damage:13, range: 6, interval: 2, baseType: 2, cost: 200, attack: { type: "normal" } },
